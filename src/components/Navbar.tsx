  ...
  return (
    <nav className="sticky left-0 top-0 z-[100] w-full bg-bgDark shadow-lg">
      ...
      >
        ...
        >
          {/* for mobile view */}
          <span className="sm:hidden">@Navin</span>
          {/* for web view */}
          <span className="hidden sm:block">@Navin kumar</span>
        </ScrollLink>
            ...
            >
              <div className="relative flex flex-col p-5 sm:p-10 lg:hidden">
                ...
                <div className="flex gap-4 border-b-2 border-b-white p-6 text-[22px]">
                  <a
                    href="https://www.linkedin.com/in/navin-kumar-14b980268?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                    target="_blank"
                  >
                    <BsLinkedin />
                  </a>
                  <a href="https://github.com/Kumar0264" target="_blank">
                    <BsGithub />
                  </a>
                  {/* <a href="https://twitter.com/aashish_dhimaan" target="_blank">
                    <FaXTwitter />
                  </a> */}
                  <a href="mailto:rnkumar0264@gmail.com" target="_blank">
                    <HiMailOpen />
                  </a>
                </div>
        ...
        <div className="hidden items-center justify-between gap-2 text-[24px] lg:flex">
          ...
          <span className="cursor-pointer px-1 py-2 transition-all duration-500 ease-in-out hover:-translate-y-[2px]">
            <a
              href="https://github.com/Kumar0264"
              target="_blank"
              title="Github"
            >
              <BsGithub />
          ...
          <span className="cursor-pointer px-1 py-2 transition-all duration-500 ease-in-out hover:-translate-y-[2px]">
            <a
              href="mailto:rnkumar0264@gmail.com"
              target="_blank"
              title="Email"
            >
              <HiMailOpen />
