    ...
    >
      <div className="flex flex-col items-center justify-center gap-4 lg:flex-row lg:items-start">
        ...
        >
          ...
          >
            Hi, I&apos;m <span className="text-heading">Navin</span> a{" "}
            <span className="text-heading">passionate</span> Front-end Web Developer.
          </motion.h1>
          ...
          >
            <TypeAnimation
              ...
              sequence={[
                500,
                "I develop interactive UI using React.js",
                1000,
          ...
          <div className="flex flex-col items-center gap-8 sm:gap-4 sm:flex-row ">
            ...
            >
              <a
                href="https://drive.google.com/file/d/1Ye4MVk7f2vC6wCjcyr9_r9b38V5mIman/view?usp=drive_link"
                target="_blank"
